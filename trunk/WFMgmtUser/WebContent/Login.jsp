...
<div id="templatemo_main">    
	...
	<s:form action="login.action" method="post" id="myForm">
		<s:select label="Select User" id="myselect" name="user" headerValue="--SelectUser--" headerKey="1" list="{'Administrator','Member'}" />
	    ...
	    <s:submit name = "submit" id="mylogin" value="Login" align="center" />
