...
public class SendMail {
	...
	public void sendMail(String m_from, String m_to, String m_subject,
		...
		try {
			...
			/*
			 * m_Session = Session.getDefaultInstance(m_properties,new
			 * Authenticator() { protected PasswordAuthentication
			 * getPasswordAuthentication() { return new
			 * PasswordAuthentication("ksbhavaani","<enter password>"); //
	...
	public static void main(String[] args) {
		...
		send_mail.sendMail("ksbhavaani@gmail.com", "ksbhavaani@gmail.com",
				"Hello Mail",
				"Hi this is Test mail from Java Srilankan Support");
	}
