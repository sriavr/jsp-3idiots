...
return new PasswordAuthentication("ksbhavaani","<enter password>"); // username and the password
}
});*/
...
send_mail.sendMail("ksbhavaani@gmail.com", "ksbhavaani@gmail.com", "Hello Mail", "Hi this is Test mail from Java Srilankan Support");
}
