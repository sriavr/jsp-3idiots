...
<body>
<center><h2>Welcome to Manager Information Form</h2></center>
...
<s:form action="reportingmanager.action" method="post">
<table>
 ...
 <!-- <tr> <td> <h4> Address: <s:property value="address" /> </h4> </td> </tr> -->
 <tr> <td> <h4> MemberManagerID: <s:property value="membermanagerid" /> </h4> </td> </tr>   
 <tr> <td> <s:submit name = "submit" id="mysubmit" value="View Request"
      align="center" /> </td> </tr>
