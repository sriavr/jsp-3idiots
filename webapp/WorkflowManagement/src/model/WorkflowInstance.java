...
public class WorkflowInstance {
	...
	private WorkflowItem wfitemid = new WorkflowItem();
	...
	public int update() {
		String updateSQL = "update workflowinstance " + "set memberid = '"
				...
				+ "', wfitemid = '" + wfitemid + "' where wfinstanceid = "
				+ wfinstanceid;
		...
		try {
			while (resultSet.next()) {
				...
				workflowinstance.currentstate.setStateID(resultSet
						.getInt("currentstate"));
				workflowinstance.wfitemid.setWfitemid(resultSet
						.getInt("wfitemid"));
...
*/	
	...
	public WorkflowItem getWfitemid() {
		return wfitemid;
	}

	public void setWfitemid(WorkflowItem wfitemid) {
